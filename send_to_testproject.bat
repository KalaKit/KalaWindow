...
set "ORIGIN_HEADER3=%INPUT_ROOT%\install-release\include\graphics.hpp"
set "ORIGIN_HEADER4=%INPUT_ROOT%\install-release\include\messageloop.hpp"
...
set "TARGET_HEADER3=%TARGET_ROOT%\graphics.hpp"
