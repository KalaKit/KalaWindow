...
namespace KalaWindow::Core
{
	...
	unordered_map<Window*, unique_ptr<WindowContent>> windowContent{};

	unordered_map<u32, unique_ptr<Font>> createdFonts{};
	...
	vector<WindowContent*> runtimeWindowContent{};

	vector<Font*> runtimeFonts{};
