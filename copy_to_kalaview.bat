...
set "EXTERNAL_TARGET=..\KalaView\_external_shared"
set "DEBUG_TARGET=..\KalaView\_external_shared\KalaWindow\debug"
set "RELEASE_TARGET=..\KalaView\_external_shared\KalaWindow\release"
...
set "CLEAN_IMGUI=..\KalaView\_external_shared\delete_imgui_vulkan_files.bat"
